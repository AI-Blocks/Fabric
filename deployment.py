...
bounding_box_type = {
    ...
    # N: output, "I": image_id, L: labels, P: probability, x_min, x_max, y_min,
...
classification_type = {
    "name": "classification",
    "dims": ["N", ["P"], 1, 1]
    # N: batch_size, "P": probabilities, "S": softmax probabilities
...
face_detection = {
    ...
    "block_outputs": [
        {
            "name": "bounding_box",
            "dims": [1, 1, "N", ["I", "L", "P", "x_min", "y_min", "x_max", "x_min"]]
        }
    ]
}
...
age_recognition = {
    ...
    "block_outputs": [
        {
            "name": "classification",
            "dims": ["N", 1, "V", 1, 1] # NEED TO VERIFY FIRST DIM IS BATCH
        },
        {
            "name": "classification",
            "dims": ["N", 1, ["P"], 1, 1]
